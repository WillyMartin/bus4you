...
CREATE TABLE IF NOT EXISTS `keitaro_archive_browsers` (
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_countries` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_device_types` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_hours` (
  `group_id` int(10) unsigned NOT NULL,
  `date` date NOT NULL,
  `counts` varchar(250) NOT NULL,
  KEY `group_id` (`group_id`,`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `keitaro_archive_keywords` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_os` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_referers` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_se` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_sources` (
  `id` int(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `keitaro_archive_visits` (
  `date` date NOT NULL,
  `group_id` int(11) NOT NULL,
  `uniq` int(11) NOT NULL DEFAULT '0',
...
INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20170808235201_CreateBranding');INSERT IGNORE INTO schema_migrations(`name`) VALUES('Migration_20170813111110_DenormalizeAffiliateNetwork');
